...
namespace Draw
{
	...
	public class DisplayProcessor
	{
		...
		public void ReDraw(object sender, PaintEventArgs e)
		{
			...
			//{
			//    e.Graphics.Transform = item.TransformationMatrix;
		...
		public virtual void Draw(Graphics grfx) // Moje da se predefinira za6toto e virtual
		{
			foreach (Shape item in ShapeList){
				DrawShape(grfx, item);
			}
